...
from keras.layers import MaxPooling2D, AveragePooling2D, GlobalMaxPooling2D, GlobalAveragePooling2D, ZeroPadding2D
...
model.add(ZeroPadding2D((1,1),input_shape=x_train_train.shape[1:]))
...
es = keras.callbacks.EarlyStopping(monitor = 'val_loss', patience = 20, verbose = 1)
